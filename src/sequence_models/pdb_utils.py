...
def ab_2_mif_vocab():
    ablang_vocab = {"<": 0, "-": 21, ">": 22, "*": 23, "M": 1, "R": 2, "H": 3, "K": 4, "D": 5, "E": 6, 
     "S": 7, "T": 8, "N": 9, "Q": 10, "C": 11, "G": 12, "P": 13, "A": 14, "V": 15, 
     "I": 16, "F": 17, "Y": 18, "W": 19, "L": 20}

    mifst_vocab = {0: 'A', 1: 'C', 2: 'D', 3: 'E', 4: 'F', 5: 'G', 6: 'H', 7: 'I', 8: 'K', 
      9: 'L', 10: 'M', 11: 'N', 12: 'P', 13: 'Q', 14: 'R', 15: 'S', 16: 'T', 
     17: 'V', 18: 'W', 19: 'Y', 20: 'B', 21: 'Z', 22: 'X', 23: 'J', 24: 'O', 
     25: 'U', 26: '<', 27: '-', 28: '*', 29: '>'}

    #translates ablang encoding to mifst encoding by swapping columns via matrix multiplication
    tr_mat = np.zeros((24,30))

    for col, val in mifst_vocab.items():
        try:
            ab_col = ablang_vocab[val]
            tr_mat[ab_col,col] = 1
        except:
            continue
    
    return torch.tensor(tr_mat, dtype=torch.float)
